...
class Program
{
    ...
    static async Task RunWithContinuation(List<int> ids)
    {
        ...
        */
        ...
        await Task.WhenAll(continuations).ConfigureAwait(ConfigureAwaitOptions.SuppressThrowing);
    }
    ...
    static async Task RunWithForEachAsync(List<int> ids)
    {
        ...
        */
        ...
        /*        // Short-circuit exception handling (with continuation)
                await Parallel.ForEachAsync(ids,
                    new ParallelOptions() { MaxDegreeOfParallelism = 3 },
                    async (id, _) =>
                    {
        ...
        */
        ...
        /*        // Short-circuit exception handling (ConfigureAwaitOptions)
                try
                {
                    await Parallel.ForEachAsync(ids,
                        new ParallelOptions() { MaxDegreeOfParallelism = 3 },
